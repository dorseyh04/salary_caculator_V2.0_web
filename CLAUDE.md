...
> 本文档为项目级 Claude Code 指引。每次新会话 Claude Code 会自动读取本文件以保持上下文连贯。

## 项目定位

康乃尔业务人员月度薪酬核算 Web 系统。基于《2026 年滨州康乃尔经营薪酬考核方案 V2.0》（2026 年 5 月 1 日起执行）。
